...
//  FencingLog
//
//  Created by Samantha Herdman on 9/8/17.
...
class OpponentProfileViewController: UITableViewController, UITextFieldDelegate, ValidationDelegate {
    ...
    @IBAction func doSaveProfile(_ sender: Any) {
        ...
        if let fencerId = fencerId {
            let fencerData = ["userId": fencerId,
                              ...
                              "weapons": weapons,
                              "placeHolderOwner": owner!] as [String : Any]
...
extension OpponentProfileViewController {
